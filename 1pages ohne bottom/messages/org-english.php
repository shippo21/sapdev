...
$messages["g3"]		=		"Site not found, please inform the administrator";
$messages["g4"]		=		"Messages couldn't be loaded!";
$messages["g5"]		=		"Settings couldn't be loaded!";
//
//
//  ./install.php
$messages["i0"]		=		"SAP AFTER INSTALL GREETINGS MESSAGE ";                                                     ///////////////// MUST BE EDIT
$messages["i1"]		=		"No database connection!";
$messages["i2"]		=		'MySQL: notices could not be created!';
$messages["i3"]		=		'MySQL: servers could not be created!!';
$messages["i4"]		=		'MySQL: settings could not be created!!';
$messages["i5"]		=		'MySQL: users could not be created!!';
$messages["i6"]		=		'MySQL: notices Content could not be inserted!';
$messages["i7"]		=		'MySQL: notices Content could not be inserted!';
...
$messages["i10"]	=       'Installation of Streamers Panel ' . SAP_VERSION;
$messages["i11"]	=		'INSTALLATION';
$messages["i12"]	=		'Have fun!';
$messages["i13"]	=		'PHP extensions:';
$messages["i14"]	=		'SSH2 not found!';
$messages["i15"]	=		'SSH2 OK';
$messages["i16"]	=		'MySql not found!';
...
$messages["i25"]	=		'Directory permissions "page" OK!';
$messages["i26"]	=		'Directory permissions "temp" OK!';
$messages["i27"]	=		'Directory permissions "pages" FALSCH ';
$messages["i28"]	=		'Directory permissions "temp" FALSCH';
...
$messages["i39"]	=		'Linux: &quot;GNU C Library&quot; (glibc) on a 32 Bit environment with version 6 or higher';
$messages["i40"]	=		'Linux: Sudo is required';
$messages["i41"]	=		'MySQL Database Server';
$messages["i42"]	=		'Notice';
$messages["i43"]	=		'In this box, you will receive information on the operation';
$messages["i44"]	=		'MySQL Configuration';
$messages["i45"]	=		'MySQL Server';
$messages["i46"]	=		'Address of the MySQL Server (commonly localhost)';
$messages["i47"]	=		'MySQL Username';
$messages["i48"]	=		'';//Username of MySQL
$messages["i49"]	=		'MySQL Password';//MySQL Paswort
$messages["i50"]	=		'Database name';
$messages["i51"]	=		'';// Database Name for MySQL
$messages["i52"]	=		'Admin Account';
$messages["i53"]	=		'Admin Username';
$messages["i54"]	=		'';//Enter Admin Username for Panel
$messages["i55"]	=		'Admin Password';
$messages["i56"]	=		'';//Enter Admin Username for Panel
$messages["i57"]	=		'Server Settings';
$messages["i58"]	=		'Server Path to Panel';
$messages["i59"]	=		'';//The full path the Panel is located
$messages["i60"]	=		'IP or Domain of the Server';
$messages["i61"]	=		'';// The IP or Domain of this Server
$messages["i62"]	=		'Server Name';
$messages["i63"]	=		'Name of the server';
$messages["i64"]	=		'SSH connection settings';
$messages["i65"]	=		'SSH username';

$messages["i67"]	=		'SSH password';
$messages["i68"]	=		'SSH port';
$messages["i69"]	=		'Language';
$messages["i70"]	=		'SAP language';
$messages["i71"]	=		'UI language';
...
$messages["18"]		=		"The message with ID ".(isset($_GET['delmessid']) ? $_GET['delmessid'] : null)." was successfully deleted from the database";
$messages["19"]		=		"The message with ID ".(isset($_GET['delmessid']) ? $_GET['delmessid'] : null)." could not be deleted from the database";
...
//
// autodj_bottom.php
$messages["dd1"]		=		"random playback on";
$messages["dd2"]		=		"random playback off";
$messages["dd3"]		=		"Crossfade on";
$messages["dd4"]		=		"Crossfade off";
$messages["dd5"]		=		"ID3 usage on";
$messages["dd6"]		=		"ID3 usage off";
$messages["dd7"]		=		"display stream public";
$messages["dd8"]		=		"dont display stream public";

//
//
//admserver_bottom.php
$messages["dd9"]		=		"Updates would be executed";
$messages["dd10"]		=		"Updates would be inhibited";
$messages["dd11"]		=		"AutoDJ Config will be saved";
$messages["dd12"]		=		"AutoDJ Config will be deleted";
$messages["dd13"]		=		"Shoutcast Config on";
$messages["dd14"]		=		"Shoutcast Config off";
